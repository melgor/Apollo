...
parser.add_argument('--transformed_path', required=True,help='path where to store transformed test images')
...
def test_accuracy_multi(args):
  ...
  pred = PredictionAugmented(args.proto_path,args.bin_path,args.transformed_path)
  max_value = 512
  curr_value = 0
