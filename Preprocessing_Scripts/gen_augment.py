            ...
            for fileName in fileNameDir[2]:
                ...
                for degrees in [45, 90, 135, 180, 225, 270, 315]:
                    ...
                    if (folder + '/' + fileName) in X_train_files:
                        ...
                        X_val.append(folder + '/' + fileName.split('.')[0] + '_' + str(degrees) + '.jpg' + ' ' + str(current_class_id))
                    ...
                    if (folder + '/' + fileName) in X_train_files:
                        ...
                        X_val.append(folder + '/' + fileName.split('.')[0] + '_' + str(degrees) + '_sheared1.jpg' + ' ' + str(current_class_id))
                    ...
                    if (folder + '/' + fileName) in X_train_files:
                        ...
                        X_val.append(folder + '/' + fileName.split('.')[0] + '_' + str(degrees) + '_shear1_scale1.jpg' + ' ' + str(current_class_id))
                    ...
                    if (folder + '/' + fileName) in X_train_files:
                        ...
                        X_val.append(folder + '/' + fileName.split('.')[0] + '_' + str(degrees) + '_shear1_scale2.jpg' + ' ' + str(current_class_id))
                    ...
                    if (folder + '/' + fileName) in X_train_files:
                        ...
                        X_val.append(folder + '/' + fileName.split('.')[0] + '_' + str(degrees) + '_sheared2.jpg' + ' ' + str(current_class_id))
                    ...
                    if (folder + '/' + fileName) in X_train_files:
                        ...
                        X_val.append(folder + '/' + fileName.split('.')[0] + '_' + str(degrees) + '_shear2_scale1.jpg' + ' ' + str(current_class_id))
                    ...
                    if (folder + '/' + fileName) in X_train_files:
                        ...
                        X_val.append(folder + '/' + fileName.split('.')[0] + '_' + str(degrees) + '_shear2_scale2.jpg' + ' ' + str(current_class_id))
                    ...
                    if (folder + '/' + fileName) in X_train_files:
                        ...
                        X_val.append(folder + '/' + fileName.split('.')[0] + '_' + str(degrees) + '_translate1.jpg' + ' ' + str(current_class_id))
                    ...
                    if (folder + '/' + fileName) in X_train_files:
                        ...
                        X_val.append(folder + '/' + fileName.split('.')[0] + '_' + str(degrees) + '_translate2.jpg' + ' ' + str(current_class_id))
                    ...
                    if (folder + '/' + fileName) in X_train_files:
                        ...
                        X_val.append(folder + '/' + fileName.split('.')[0] + '_' + str(degrees) + '_translate3.jpg' + ' ' + str(current_class_id))
                    ...
                    if (folder + '/' + fileName) in X_train_files:
                        ...
                        X_val.append(folder + '/' + fileName.split('.')[0] + '_' + str(degrees) + '_translate4.jpg' + ' ' + str(current_class_id))
